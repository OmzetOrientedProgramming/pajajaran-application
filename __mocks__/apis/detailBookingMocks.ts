...
// Get Detail Booking status booking berhasil
export const dummyGetDetailBookingBerhasilResponse = {
  status: 200,
  message: 'success',
  data: {
    id: 1,
...
export const mockGetDetailBookingBerhasilResponse: AxiosResponse = {
  data: dummyGetDetailBookingBerhasilResponse,
  status: 200,
  statusText: 'OK',
  headers: {},
  config: {},
...
export const getDetailBookingBerhasilParams = {
  id: '1',
};
