...
const Batal: React.FC<ConfirmModalContentInterface> = ({
  setIsOpen,
  handleConfirm,
}) => {
  return (
    <div>
      ...
      <h1 tw="text-4xl font-bold mt-7 mb-8">Tolak?</h1>
      <div tw="flex flex-row items-center justify-center w-full gap-x-7">
        <button
          ...
          css={[
            ...
            `,
            tw`font-bold text-2xl w-full border-2 background[#FE3131] color[#FFFFFF] duration-150 hover:(brightness-110)`,
          ]}
        >
          Ya
        </button>
