...
const ProfileCard: React.FC<ProfileCardProps> = (props) => {
  ...
  const handleConfirm = (
    ...
    if (newBusinessDescription.length < 10) {
      toast.error('Panjang Deskripsi Bisnis harus diatas 10', {
        duration: 1500,
      });
      return;
    }
    ...
    if (
      newBusinessDescription === props.description &&
      newBusinessName === props.name
    ) {
    ...
    updateProfile(
      { name: newBusinessName, description: newBusinessDescription },
      {
        onSuccess: (res: any) => {
          setIsOpen(false);
      ...
      <div tw="flex flex-row items-center justify-center">
        ...
        <div tw="w-2/3 flex flex-col m-5">
          <div tw="flex flex-row">
            ...
            <a
              tw="block cursor-pointer hover:scale-110"
