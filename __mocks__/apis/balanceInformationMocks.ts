...
export const dummyGetBalanceInformationEmptyResponse = {
  status: 200,
  message: 'success',
  data: {
    latest_disbursement_date: '2022-12-31T11:59:30Z',
...
export const mockGetBalanceInformationEmptyResponse: AxiosResponse = {
  data: dummyGetBalanceInformationEmptyResponse,
  status: 200,
  statusText: 'OK',
  headers: {},
  config: {},
