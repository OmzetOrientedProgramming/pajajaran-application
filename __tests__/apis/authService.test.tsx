...
import {dummyLoginResponse, loginParams, mockLoginResponse,} from '../../__mocks__/apis/authMocks';
  ...
  test('return success', async () => {
    ...
    expect(mockAxios.post).toHaveBeenCalledWith(
      endpoint.login,
      {
        ...
        recaptcha_token: loginParams.recaptchaToken,
      },
      {
        headers: headers,
      }
    );
    expect(data.data).toEqual(dummyLoginResponse);
  });
});
